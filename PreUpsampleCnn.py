...
class PreUpsampleCnn(tf.keras.Model):
    ...
    def __init__(self, lr_image_width, hr_image_width):
        ...
        """
        super(PreUpsampleCnn, self).__init__()
        ...
        # downsampling
        self.d1 = Down(128/8, (3, 3), False)
        self.d2 = Down(128/8, (3, 3), False)
        self.d3 = Down(256/8, (3, 3), True)
        self.d4 = Down(512/8, (3, 3), True)
        self.d5 = Down(512/8, (3, 3), True)

        # upsampling
        self.u1 = Up(512/8, (3, 3), False)
        self.u2 = Up(256/8, (3, 3), False)
        self.u3 = Up(128/8, (3, 3), False)
        self.u4 = Up(128/8, (3, 3), False)
